...
import { initStoreWithActions, TestCase, dataSet } from "../test-utils";

const noParticipants: TestCase = {
...
const someParticipantsEnrolled: TestCase = {
...
const someParticipantsModified: TestCase = {
